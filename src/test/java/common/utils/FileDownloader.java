...
//    }
     ...
     * @throws Exception
     */
    public String downloadFile(String url, String pdfFile) throws Exception {
        return downloader(url, pdfFile);
    }
     ...
     */
    private String downloader(String fileToDownloadLocation, String pdfFile) throws IOException, NullPointerException, URISyntaxException {
